...
namespace Chess
{
    class Moves
    {
        ...
        {
            if (fm.AbcDeltaX == 1 && fm.AbcDeltaY == 2) return true;
            if (fm.AbcDeltaX == 2 && fm.AbcDeltaY == 1) return true;
            return false;
        }
        ...
        {
            if (fm.AbcDeltaX <= 1 && fm.AbcDeltaY <= 1)
                return true;
            return false;
        }

        private bool CanStrainghtMove()
        {
            Square at = fm.from;
            do
            {
