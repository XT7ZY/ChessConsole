...
namespace Chess
{
    class FigureMoving
    {
        ...
        public FigureMoving (FigureOnSquare fs, Square to, Figure promotoin = Figure.none)
        {
        ...
        public int AbcDeltaX { get { return Math.Abs(DeltaX); } }
        public int AbcDeltaY { get { return Math.Abs(DeltaY); } }
